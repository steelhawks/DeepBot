...
public class Tape extends VisionSubsystem
{
  ...
  public void align()
  {
    ...
    {
      if (Math.abs(Robot.DRIVETRAIN.gyro.getAngle()) < (getAngle() - 0.1) && getNTXPos("Tape") < getXPosLeftLimit())
      {
        Robot.DRIVETRAIN.rotate(0.325);
      }
      else if(Math.abs(Robot.DRIVETRAIN.gyro.getAngle()) < (getAngle() - 0.1) && getNTXPos("Tape") > getXPosRightLimit()) 
      {
        Robot.DRIVETRAIN.rotate(-0.325);
      }
      else 
  ...
  /** Gets the x cooridnate of the left border of the center of the tape pair. @return The x cooridnate of the left border of the tape pair */
  public double getXPosLeftLimit()
  {
    return this.xPosLeftLimit;
  }

  /** Gets the x cooridnate of the right border of the center of the tape pair @return The x cooridnate of the right border of the tape pair */
  ...
  /** Returns true if alignment and distancing to the center of the tape pair is complete. @return If alignment and distancing to the center of the tape pair is complete */
